...
GPIO.setup(17, GPIO.IN, pull_up_down=GPIO.PUD_UP)  # Button on GPIO 17
...
while True:
    ...
    if not ret:
        ...
        break
    switch_state_c = GPIO.input(27) == GPIO.LOW
    switch_state_s = GPIO.input(17) == GPIO.LOW
    ...
    if key == ord('s') or switch_state_s:  # Press 's' key to capture and detect
        ...
        break
    elif key == ord('c') or switch_state_c:
